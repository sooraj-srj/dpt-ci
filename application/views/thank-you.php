                            ...
                            <div class="panel with-nav-tabs panel-default">
                                <div class="panel-heading">
                                    <!-- <ul class="nav nav-tabs">
                                        <li class="active"><a href="#tab1default" data-toggle="tab">Thank You!</a></li>                                        
                                    </ul> -->
                                    <?php if(!empty(f('success_message'))){ ?> <h2 class="text-success">Thank you! </h2> <?php } ?>
                                    <?php if(!empty(f('error_message'))){ ?> <h2 class="text-danger">Sorry! </h2> <?php } ?>
